...
def exec_adcirc_url(urls, rootdir, iometadata, adc_yamlname, node_idx, station_ids, grid):
    ...
    #
    utilities.log.info("NOTE Rounding ADC timer - Use this only for the EC95D data sets")
...
#rootdir = utilities.fetchBasedir(inrootdir) # Ensure the directory exists
    ...
    obs_yamlname = '/projects/sequence_analysis/vol1/prediction_work/ADCIRCSupportTools/ADCIRCSupportTools/config/obs.hsofs.yml'
    ...
    outfiles['OBS_SMOOTHED_JSON']=detailedJ
