###########################################################################
# ADCIRC Data Assimilation experimental pipeline. Feb 2021
# In this experimental ADDA, instead of kriging the MEAN residual values
# we perform a stationarity-corrected ARIMA fit of the data. Then we predict 
# out 1 hour, then build the krigged surface.
###########################################################################
