...
# URL test Launch the job using default directory metadata
runProps = os.system('python execute_APSVIZ_pipeline.py --url "/projects/sequence_analysis/vol1/prediction_work/Reanalysis/LOCAL_NC_DATA/fort.63.nc"')

#APSVIZ test example
runProps = os.system('python execute_APSVIZ_pipeline.py --url "http://tds.renci.org:8080/thredds/dodsC/2021/nam/2021010500/hsofs/hatteras.renci.org/hsofs-nam-bob-2021/namforecast/fort.63.nc"')
