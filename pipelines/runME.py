...
runProps = os.system('python execute_APSVIZ_pipeline.py --url "http://tds.renci.org:8080/thredds//dodsC/2020/nam/2020092118/hsofs/hatteras.renci.org/hsofs-nam-bob/namforecast/fort.63.nc"')
