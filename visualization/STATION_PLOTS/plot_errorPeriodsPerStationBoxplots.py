...
el='/projects/sequence_analysis/vol1/prediction_work/ADDA_202005011200_202005051200/errorfield/stationSummaryAves_202005011200_202005051200.csv'
...
dfs = pd.read_csv(el,header=0, index_col=0)
...
bplot = sns.swarmplot(
              ...
              color='black',
              alpha=0.25)
bplot.set_ylabel(r'Period $\overline{\rm \Delta WL}$ (m) ')
bplot.set_xticklabels(bplot.get_xticklabels(),rotation='vertical',fontsize=6)
bplot.set_xlabel("Stations",fontsize=6)
bplot.set_xlabel('')
bplot.set_title('Time range {} to {}'.format( df_adc.index.min(),df_adc.index.max()))
plt.savefig('PeriodDist_perstation.png')
plt.show()
