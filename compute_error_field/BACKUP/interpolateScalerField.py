...
class interpolateScalerField(object):
    ...
    def __init__(self, datafile = './kriging_error_test_noclamp.dat',
                 ...
                 clampingfile='./clamp_list.dat', model = 'kriging', metadata='', rootdir='None'): 
        """
...
##
    def optimize_kriging(self, krig_object, param_dict, vparams_dict ):
        """
        vparams has LISTS as values for each key. 
...
##
    def CVKrigingFit(self, param_dict, vparams):
        ...
        #scoring='accuracy'
        estimator = GridSearchCV(newKrige(variogram_parameters=vparams), param_dict, scoring='r2',verbose=True, iid=True,
